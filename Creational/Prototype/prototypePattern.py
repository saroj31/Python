"""
bst used when we have acenario where we have to copy or clone large objects to a new object.
This pattern is used if we need to optimize the process.

It might be that we need to avoid some expensive parts of an object in our cloning of the objects.
"""
...
# Main class/object that will do the prototyping
class Prototype:
    def __init__(self):
        self.registry = {}
...
def main():
    ...
    site2 = proto.clone(
        "python-001", #registry name identifier
